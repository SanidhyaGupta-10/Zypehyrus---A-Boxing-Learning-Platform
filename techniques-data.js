    ...
    stances: [
        {
            ...
            score: 98,
            desc: "The foundation of all combat movement. Proper stance ensures balance for the Aerial vertical leaps and stability for power shots.",
            steps: [
        ...
        },
        {
            ...
            score: 25,
            desc: "The mirror image of Orthodox. Often tricky for opponents to deal with due to the open angle.",
            steps: [
    ...
    punches: [
        {
            ...
            score: 85,
            isAiPick: true,
            desc: "A straight lead-hand punch. Used for range-finding and setting up power. The 'snapping' motion is key.",
            steps: [
        ...
        },
        {
            ...
            score: 60,
            desc: "A straight rear-hand punch. High power generated from the rotation of the rear hip and foot.",
            steps: [
        ...
        },
        {
            ...
            score: 45,
            desc: "A semi-circular punch delivered with a bent arm. Focuses on rotational core strength.",
            steps: [
        ...
        },
        {
            ...
            score: 30,
            desc: "An upward-moving punch from the waist. Used for close-range 'Shoe-Shine' drills.",
            steps: [
    ...
    kicks: [
        {
            ...
            score: 40,
            desc: "A linear thrust using the ball of the foot. Great for balance and core stability.",
            steps: [
        ...
        },
        {
            ...
            score: 92,
            desc: "A rotational strike using the shin. Requires significant hip mobility.",
            steps: [
        ...
        },
        {
            ...
            score: 75,
            desc: "A close-range upward thrust. This is a primary driver for intensity.",
            steps: [
        ...
        },
        {
            ...
            score: 55,
            desc: "A powerful lateral thrust using the heel. Excellent for glute and lateral stability.",
            steps: [
    ...
    defense: [
        {
            ...
            score: 65,
            desc: "Moving the head slightly to the left or right to avoid a straight punch.",
            steps: [
        ...
        },
        {
            ...
            score: 30,
            desc: "A 'U' shaped movement under a hook.",
            steps: [
        ...
        },
        {
            ...
            score: 50,
            desc: "Rotating on the lead foot to change the angle of attack.",
            steps: [
